      ...
      <section className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-responsive-4xl font-satoshi font-bold text-white mb-4">
              Powerful Features
            </h2>
            <p className="text-responsive-lg text-white/70 max-w-2xl mx-auto mobile-padding">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-satoshi font-bold text-white mb-6">
              Ready to Access Rehbar AI Desktop?
            </h2>
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Join our exclusive portal to download the powerful desktop application
            </p>
