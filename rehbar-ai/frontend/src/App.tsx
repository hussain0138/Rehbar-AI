          ...
          <AnimatePresence mode="wait">
            <Suspense fallback={<PageLoader />}>
              <Routes>
                ...
                <Route path="/sponsor" element={<About />} />
                ...
                {/* Redirect old extension routes to desktop */}
                <Route path="/extension" element={<Desktop />} />
                <Route path="/chrome" element={<Desktop />} />
                <Route path="/browser" element={<Desktop />} />
              </Routes>
            </Suspense>
          </AnimatePresence>
        </main>
