...
This repository is a rebranded version of [`cheating-daddy`](https://github.com/sohzm/cheating-daddy), now called **Rehbar AI**.
...
Pull requests from the original <https://github.com/sohzm/cheating-daddy> repository can be
adapted for Rehbar AI. When merging:
