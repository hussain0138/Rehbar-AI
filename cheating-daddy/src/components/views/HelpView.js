...
export class HelpView extends LitElement {
    static styles = css`
        * {
        ...
        .option-group {
            background: var(--main-content-background, rgba(15, 23, 42, 0.9));
        ...
        .option-label::before {
            ...
            width: 3px;
            height: 14px;
            background: var(--focus-border-color, #3b82f6);
            border-radius: 1.5px;
        }
    ...
    constructor() {
        super();
        console.log('HelpView constructor called');
    ...
    getDefaultKeybinds() {
        const isMac = (window.rehbar && window.rehbar.isMacOS) || navigator.platform.includes('Mac');
        return {
    ...
    render() {
        console.log('HelpView render called');
        const isMacOS = (window.rehbar && window.rehbar.isMacOS) || navigator.platform.toUpperCase().indexOf('MAC') >= 0;
        const isLinux = (window.rehbar && window.rehbar.isLinux) || navigator.platform.toUpperCase().indexOf('LINUX') >= 0;

        return html`
            <div class="help-container">
                <div style="color: white; padding: 20px; background: rgba(59, 130, 246, 0.2); border: 1px solid #3b82f6; border-radius: 8px; margin: 10px;">
                    <h2 style="color: #3b82f6; margin: 0 0 15px 0;">🛠️ Help & Shortcuts - Rehbar AI</h2>
                    <p style="margin: 0 0 10px 0;">All your help and shortcuts are here.Developed by Team Rehbar-AI-Version : Alpha</p>
                    <p style="margin: 0;">If you can see this, the component is working!</p>
                </div>
