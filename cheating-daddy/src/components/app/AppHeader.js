...
export class AppHeader extends LitElement {
    ...
    getViewTitle() {
        const titles = {
            onboarding: 'Welcome to Rehbar AI',
            main: 'Rehbar AI',
            customize: 'Customize',
            help: 'Help & Shortcuts',
        ...
        return titles[this.currentView] || 'Rehbar AI';
    }
                    ...
                    ${this.currentView === 'assistant'
                        ? html`
                              <button @click=${this.onHideToggleClick} class="button">
                                  Hide&nbsp;&nbsp;<span class="key" style="pointer-events: none;">${(window.rehbar && window.rehbar.isMacOS) ? 'Cmd' : 'Ctrl'}</span
