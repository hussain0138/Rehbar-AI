...
export class RehbarAiApp extends LitElement {
    ...
    handleCustomizeClick() {
        console.log('Switching to customize view');
        this.currentView = 'customize';
        this.requestUpdate();
    }

    handleHelpClick() {
        console.log('Switching to help view');
    ...
    async handleStart() {
        ...
        console.log('rehbar object:', window.rehbar);

        if (window.rehbar && window.rehbar.initializeGemini) {
            await window.rehbar.initializeGemini(this.selectedProfile, this.selectedLanguage);
            ...
            console.error('rehbar object or initializeGemini function not found');
        }
    }
    ...
    async handleSendText(message) {
        const result = await window.rehbar.sendTextMessage(message);
...
customElements.define('rehbar-ai-app', RehbarAiApp);